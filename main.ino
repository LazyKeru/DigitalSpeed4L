...
int kmPerHours(int RatePerMinute){
  return ( 3.14 * DIAMETRE_ROUE * RatePerMinute * 60 * 0.00001  );
}

void showSpeed(int speedInKmPerHour){
  display.showNumberDec(speedInKmPerHour);
}
